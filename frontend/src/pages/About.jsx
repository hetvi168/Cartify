...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Hetvi Patel (@hetvikpatel)</h3>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        <a href="" target="_blank" rel="noreferrer" style={socialBtnStyle}>🌐 Website</a>
              <a href="https://www.linkedin.com/in/hetvi-patel-ab6a40323/" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}>💼 LinkedIn</a>
